import type { BehaviorPatternDocument, Manifest, PatternDocument, ScreenBehavior, ScreenElements, ScreenHints, ScreenPostures, SharedPatterns, WidgetCapabilityContract } from '../../types';
import {
