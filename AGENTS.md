...
**Start here**: [`docs/v2-substrate-ladder-plan.md`](docs/v2-substrate-ladder-plan.md) — the active plan. ~30 minutes. Then [`docs/v2-substrate-reality-study.md`](docs/v2-substrate-reality-study.md) — the first real Reactive contact (2026-09-16) and, in its §§9–10, what the substrate and ladder changed in response and how the single held-out route scored. The substrate is at 1.1.0 (`generic` role, `naming`/`placeholder`/`clickable` axes, `reactive-block` chrome, 33 roles); the ladder resolves placeholder-named fields, roleless handler-owning clickables, landmark-scoped targets, and row-scoped controls. Then [`docs/v2-reactive-discovery-handoff.md`](docs/v2-reactive-discovery-handoff.md) — the three app-agnostic evidence channels (accessibility tree, handler ownership, module manifest); its N1–N10 are landed and re-measured in the study's §9.5. Companions: [`docs/v2-substrate-source-survey.md`](docs/v2-substrate-source-survey.md) (Reactive-is-target scope correction + observation-axes catalog) and [`docs/v2-substrate-ladder-plan.d0a-harness-design.md`](docs/v2-substrate-ladder-plan.d0a-harness-design.md) (sophisticated 4-phase hydration heuristic + in-page evaluator design).
