...
1. [`docs/v2-direction.md`](docs/v2-direction.md) — primary strategy document. §§1–2 name the three folders and the seam discipline; §3 names what ports where; §4 names what reshapes vs. retires; §5 introduces the probe IR; §6 is the 10-step in-place construction order.
...
3. [`docs/v2-transmogrification.md`](docs/v2-transmogrification.md) §§1–2 and §13.0 — execution choreography and per-folder destination audit. §§1–2 name the compartmentalization mechanics; §13.0 is the authoritative per-file destination summary. §§3–12 and §§13.1–13.7 are historical lane-track detail; treat as reference until they catch up with the current framing.
