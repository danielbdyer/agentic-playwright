...
} from '../lib/domain/summary-view';
import type { SceneMetrics } from '../lib/domain/scene-state-accumulator';
import type { ConvergenceMetrics } from '../lib/domain/convergence-finale';
