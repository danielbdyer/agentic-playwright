...
import { createStrategyRegistry, type StrategyRegistry } from '../../product/runtime/resolution/strategy-registry';
import type { ResolutionStrategy, StrategyAttemptResult } from '../../product/runtime/resolution/strategy';
